...
OutputBaseFilename=AlienGamerMode-Setup-1.0.9
...
Source: "..\docs\*"; DestDir: "{tmp}\AlienGamerMode\docs"; Flags: ignoreversion recursesubdirs createallsubdirs deleteafterinstall
...
[Run]
Filename: "{sys}\WindowsPowerShell\v1.0\powershell.exe"; Parameters: "-NoProfile -WindowStyle Hidden -ExecutionPolicy Bypass -File ""{tmp}\AlienGamerMode\installer\Install-AlienGamerMode.ps1"""; StatusMsg: "Configurando AlienGamer Mode..."; Flags: waituntilterminated
