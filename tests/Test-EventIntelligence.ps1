...
$csv=Join-Path $testRoot 'evento.csv';$meta=Join-Path $testRoot 'meta.json';$markers=Join-Path $testRoot 'incidentes.json';$xlsx=Join-Path $testRoot 'AlienGamerMode-Evento-1.3.0-prueba.xlsx'
...
Write-Host "OK: reporte Event Intelligence validado en $xlsx" -ForegroundColor Green
